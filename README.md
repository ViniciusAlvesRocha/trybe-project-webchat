...
*Nome* | *Avaliação*
--- | :---:
4 - Informe a todos os clientes quem está online no momento | :heavy_check_mark:
3 - Elabore o histórico do chat para que as mensagens persistam | :heavy_check_mark:
2 - Crie um frontend para que as pessoas interajam com o chat | :heavy_check_mark:
1 - Crie um back-end para conexão simultânea de clientes e troca de mensagens em chat público | :heavy_check_mark:
